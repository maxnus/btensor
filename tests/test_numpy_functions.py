...
class Tests(TestCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual(bt.empty_like(array).shape, array.shape)
        self.assertEqual(bt.empty_like(array).dtype, array.dtype)
    ...
    def test_ones(self):
        ...
        self.assertAllclose(bt.ones_like(array), array)
    ...
    def test_zeros(self):
        ...
        self.assertAllclose(tensor, array)
        self.assertAllclose(bt.zeros_like(array), array)
