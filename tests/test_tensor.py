...
class TestArithmetic(TestCase):
    ...
    def test_binary_operator_different_basis(
        self, binary_operator, subsize1, subsize2, subbasis_type_2x, get_rootbasis_subbasis
    ):
        subtype1, subtype2 = subbasis_type_2x
        rootbasis, (subbasis1, subarg1), (subbasis2, subarg2) = get_rootbasis_subbasis(
            10, subsize1, subtype1, subsize2, subtype2
        )
        np.random.seed(0)
        ...
        expected = binary_operator(
            np.einsum("xab,ia,jb->xij", np_array1, subarg1, subarg1),
